                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-success mb-3 btn-create-class"
                                        data-toggle="modal" data-target="#createClassModal">Create New Class</button>

                                    <p class="card-description"> List of classes created</code>
                                    </p>
                                                ...
                                                @foreach($darasa as $classes)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <!-- <a href="{{ route('admin.classes.show', ['darasa' => $classes->id]) }}"
                                                                class="btn btn-primary badge-success">View</a> -->
                                                            <button type="button"
                                                                class="btn btn-primary badge-success btn-show-class"
                                                                data-url="{{ route('admin.classes.show', ['darasa' => $classes->id]) }}">
                                                                View
                                                            </button>

                                                            <!-- Edit button with data-url attribute -->
                                                            <a href="#"
                                                                data-url="{{ route('admin.classes.edit', ['darasa' => $classes->id]) }}"
                                                                class="btn btn-warning badge-warning btn-edit-class">Edit</a>

                                                            <!-- Delete button with a form -->
                                                            <form method="POST"
                                                                action="{{ route('admin.classes.destroy', ['darasa' => $classes->id]) }}"
                                                                class="d-inline">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
...
<script>
    $(document).ready(function () {
        ...
        function loadCreateClassModal() {
            $.get('{{ route('admin.classes.create') }}', function (data) {
