            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        ...
                        <h3 class="page-title"> Subtopics </h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Manage Subtopics</a></li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-success mb-3 btn-create-class"
                                        data-toggle="modal" data-target="#createClassModal">Create New Subtopic</button>

                                    <p class="card-description"> List of subtopics created</code>
                                    </p>
                                        ...
                                        <table class="table table-bordered table-contextual" id="search">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($subtopics as $subtopic)
                                                    ...
                                                    <tr>
                                                        <td>{{ $subtopic->subject->subject_name }}</td>
                                                        <td>{{ $subtopic->topic->topic_name }}</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                data-url="{{ route('admin.class_subtopics.show', ['subtopic' => $subtopic->id]) }}">
                                                                View
                                                            </button>
                                                            ...
                                                            <a href="#"
                                                                data-url="{{ route('admin.class_subtopics.edit', ['subtopic' => $subtopic->id]) }}"
                                                            ...
                                                            <form method="POST"
                                                                action="{{ route('admin.class_subtopics.destroy', ['subtopic' => $subtopic->id]) }}"
                                                                class="d-inline">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
...
<script>
    $(document).ready(function () {
        ...
        function loadCreateClassModal() {
            $.get('{{ route('admin.class_subtopics.create') }}', function (data) {
