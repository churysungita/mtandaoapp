            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="col-lg-12 stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <p class="card-description">List of video content created</p>
                                        ...
                                        <table class="table table-bordered table-contextual" id="search">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ pathinfo($contentMaterial->file_path, PATHINFO_EXTENSION) }}
                                                    </td> <!-- Display file type -->
                                                    <td>

                                                        <a href="{{ route('teacher.teachers_videos_view', ['hashedId' => $hashids->encode($contentMaterial->id)]) }}" class="btn btn-success">View</a>
