                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        {{-- <a href="{{ route('teacher.teachers_materials_view', ['id' => $post->id]) }}"
                                                            class="btn btn-success">View</a> --}}
                                                         <a href="{{ route('teacher.teachers_materials_view', ['hashedId' => $hashids->encode($post->id)]) }}" class="btn btn-success">View</a>
