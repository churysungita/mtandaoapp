<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('teacher.teachers_notes') }}">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('teacher.teachers_videos') }}">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{ route('teacher.teachers_materials') }}">View materials</a></li>
                    </li>
                </ul>
            </div>
        </li>
