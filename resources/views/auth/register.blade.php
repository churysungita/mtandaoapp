        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="address" class="block mt-1 w-full" type="text" name="address" :value="old('address')" required autofocus autocomplete="address" />
                    ...
                    <div class="mt-4">
            <x-label for="usertype" value="{{ __('Who are you?') }}" />
            <br>
            <div class="flex items-center">
                <label class="inline-flex items-center">
                    <input type="radio" name="usertype" value="3" class="form-radio" checked>
                    <span class="ml-2">Student</span>
                </label>
                <label class="inline-flex items-center ml-6">
                    <input type="radio" name="usertype" value="2" class="form-radio">
